...
Un **hypervisor di sistema** o di tipo 1 viene eseguito direttamente sopra l'hardware, dunque risulta essere un sistema operativo semplice (cioè non complesso come un classico sistema operativo host) che offre le funzionalità di virtualizzazione. In particolare, può avere un microkernel o un classico kernel monolitico e risulterà avere un minor overhead rispetto ad un hypervisor di tipo 2, dato che non c'è il livello del sistema operativo host tra VM e hardware.
