...
Quando un nuovo bit entra nella finestra, si controlla il bucket più a sinistra, ossia quello presente da più tempo. Se il suo timestamp, ossia il timestamp del bit più a destra contenuto in esso, è uguale al timestamp del bit corrente meno $N$, allora tale bucket non possiede più al suo interno nessuno degli $1$ nella finestra. Quindi, lo si elimina dalla lista dei buckets.
